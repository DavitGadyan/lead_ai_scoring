...
PROVIDERS: list[ProviderDefinition] = [
    ...
    ProviderDefinition(
        ...
        label="Zoho CRM",
        category="crm",
        description="Read lead records from Zoho CRM modules.",
        recommended_order=4,
        fields=[
            ProviderField(key="base_url", label="API Base URL", placeholder="https://www.zohoapis.com"),
            ProviderField(key="access_token", label="Access Token", required=True, secret=True),
            ProviderField(key="object_name", label="Module", placeholder="Leads"),
